...
<body>
     <nav
        class="bg-white fixed top-0 left-0 right-0 z-40 border-gray-200 shadow-sm"
        >
        <div
        ...
        >
            ...
            />
            <span
                class="self-center text-1xl font-semibold whitespace-nowrap text-clifford"
            ...
            <ul
                class="font-medium flex p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white"
            >
                <li>
                <a
                    href="/"
                ...
                <button
                    ...
                    class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded-sm md:w-auto hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0"
                >
                    Fasilitas
                    <svg
                ...
                <div
                    ...
                    class="hidden absolute z-50 mt-2 w-screen max-w-sm sm:max-w-xl md:max-w-3xl inset-x-0 mx-auto border border-gray-200 shadow-lg bg-white"
                >
                    <div
                    class="grid sm:grid-cols-2 md:grid-cols-3 gap-4 px-4 py-5 text-gray-900 max-h-[80vh] overflow-y-auto"
                    >
                    <!-- Kolom 1 -->
                    <ul>
                        <li>
                ...
                <a
                    href="{{ route('login') }}"
                    class="text-white bg-clifford hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center"
                    >Masuk</a
                >
                </li>
            </ul>
